...
// EncounterState énumération des états de la rencontre
...
// Encounter orchestrateur de rencontre avec machine à états
...
// NewEncounter crée une nouvelle rencontre
...
// SubmitAttempt soumet une tentative de réponse
...
// Resolve résout la rencontre selon l'état actuel
...
// GetCurrentState retourne l'état actuel
func (e *Encounter) GetCurrentState() EncounterState {
	return e.State
}

// GetCurrentMon retourne le WordMon actuel (peut être nil)
